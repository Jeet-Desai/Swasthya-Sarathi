...
const quickLinks01 = [
  { path: "/patient/dashboard", display: "Home" },
  { path: "/patient/about-us", display: "About Us" },
];

const quickLinks02 = [
  { path: "/patient/bookdoctor", display: "Find a Doctor" },
  { path: "/patient/bookdoctor", display: "Request an Appointment" },
];

const quickLinks03 = [{ path: "/patient/contact", display: "Contact Us" }];
